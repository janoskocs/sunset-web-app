  ...
  userBooking
    ...
    .then(() => {
      let options = {
        ...
        html:
          '<img src="https://sunset.janoskocs.com/img/hero1280gradient.jpg" style="width: 100%; height: 180px; display: block; overflow: hidden; margin: 0 auto; object-fit: cover;" /><section style="font-family: Helvetica; text-align: center; width:45%; margin: 0 auto;"> <h1>Thank you for booking your table!</h1> <h3>Your details are as follows:</h3> <p>Name: ' +
          customerName +
          "</p> <p>Seats: " +
          seatCount +
          "</p> <p>Reference: " +
          ...
          "</p> <p>Time: " +
          customerTime +
          "</p> <h3>To cancel your booking, please visit our website again and click on 'Cancel booking'</h3> <h3>This is a personal project for <a href=\"https://janoskocs.com\">janoskocs.com</a>. To work with me, please drop me an email at contact@janoskocs.com</h3></section>",
      };
